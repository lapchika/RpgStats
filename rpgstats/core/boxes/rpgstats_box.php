 ...
 */
class rpgstatsbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "rpgstats@rpgstats";
    public $boxlabel;
    public $depends = array("rpgstats");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/rpgstats/class/rpgstats.class.php";
